...
export default function AutoTable() {
    ...
    useEffect(() => {
    fetch(`${backUrl}/api/auto/stock_interno_usate`)
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 pb-4">
        <Card className="border border-red-700 rounded-md">
          <CardHeader className="p-2 bg-gradient-to-br from-red-800 to-red-700 rounded-t">
            <CardTitle className="text-sm text-white font-light">Auto In Stock Usate</CardTitle>
          </CardHeader>
                      ...
                      {expandedRow === car.id && (
                        <TableRow className="bg-gray-100">
                            ...
                            <div className="grid grid-cols-12 gap-4">
                                ...
                                {car.logo_url && (
                                    <img src={car.logo_url} alt="DALMA USATO" className="h-[100px] w-[100px] object-auto" />
                                )}
