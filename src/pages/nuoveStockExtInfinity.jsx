    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-12 gap-4 pb-4">
        ...
        <Card className="border border-red-700 rounded-md flex flex-col justify-between">
            ...
            <CardTitle className="text-sm text-white font-light">Auto In Stock Esterno</CardTitle>
            </CardHeader>
        ...
        {/* Colonna 2: Mini-card con le ubicazioni */}
        <div className="grid grid-rows-2 grid-cols-11 gap-2 col-span-11">
