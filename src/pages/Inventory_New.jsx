...
export default function LeftPanel({ onTelaioChange, refreshTrigger }) {
    ...
    const locationOptions = selectedBuilding ? buildings[selectedBuilding] : [];
    ...
    const handleTelaioInputChange = (e) => {
    ...
    const handleConfirmInventory = () => {
        ...
        const response = addVehicleToInvetory(payload);
        if (response) {
            setAlertMessage(
                response.message || "Auto confermata con successo!"
            );
            setAlertOpen(true);
            resetForm();
        }
                ...
                <Card className="rounded-2xl border border-gray-200 bg-white md:col-span-2">
                    ...
                    <CardContent className="pt-2">
                        <Input
                            ...
                            value={telaio}
                            onChange={handleTelaioInputChange}
                    ...
                    <CardContent className="pt-2">
                        {vehicleByEntity ? (
                            <div className="space-y-2 text-gray-700">
                                <div>
                                    <strong>Marca:</strong>{" "}
                                    {vehicleByEntity.marca}
                                </div>
                                <div>
                                    <strong>Modello:</strong>{" "}
                                    {vehicleByEntity.modello}
                                </div>
                                <div>
                                    <strong>Colore:</strong>{" "}
                                    {vehicleByEntity.descr_colore}
                                </div>
                                <div>
                                    <strong>Ubicazione:</strong>{" "}
                                    {vehicleByEntity.descr_ubicazione}
                                </div>
                                <div>
                                    <strong>Telaio:</strong>{" "}
                                    {vehicleByEntity.telaio}
                                </div>
                                <div>
                                    <strong>Targa:</strong>{" "}
                                    {vehicleByEntity.targa}
                                </div>
                                <div>
                                    <strong>Alimentazione:</strong>{" "}
                                    {vehicleByEntity.alimentazione}
                                </div>
                                <div>
                                    <strong>Tipo Cambio:</strong>{" "}
                                    {vehicleByEntity.tipo_cambio}
                                </div>
                                <div>
                                    <strong>Status:</strong>{" "}
                                    {vehicleByEntity.status_veicolo_desc}
                                </div>
                            </div>
                        ) : (
                ...
                <Card className="w-full border border-slate-700 rounded-t">
                    ...
                    <CardContent className="pt-2">
                        ...
                        <Button
                            ...
                            className="w-full bg-amber-500 text-gray-900 hover:bg-amber-600 pt-2"
                        >
                            Conferma Auto
                        </Button>
                    </CardContent>
