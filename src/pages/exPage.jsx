    ...
    <div className="p-6">
      ...
      <div className="auto-grid gap-8 sm:grid-cols-1 md:grid-cols-7">
        ...
        <div>
          <Card className="border border-yellow-600 rounded-md flex flex-col justify-between h-full w-full">
            <CardHeader className="p-2 bg-gradient-to-br from-yellow-600 to-yellow-500 rounded-t">
              <CardTitle className="text-[14px] text-slate-800 font-bold truncate text-center whitespace-nowrap overflow-hidden max-w-full">{conteggioPerSedeOrdinato?.[0]?.sede || "-"}</CardTitle>
            </CardHeader>
        ...
        <div>
          <Card className="border border-yellow-600 rounded-md flex flex-col justify-between h-full w-full">
            <CardHeader className="p-2 bg-gradient-to-br from-yellow-600 to-yellow-500 rounded-t">
              <CardTitle className="text-[14px] text-slate-800 font-bold truncate text-center whitespace-nowrap overflow-hidden max-w-full">{conteggioPerSedeOrdinato?.[1]?.sede || "-"}</CardTitle>
            </CardHeader>
            <CardContent className="p-4 pt-1 flex flex-col justify-center items-center h-full">
        ...
        <div>
          <Card className="border border-yellow-600 rounded-md flex flex-col justify-between h-full w-full">
            <CardHeader className="p-2 bg-gradient-to-br from-yellow-600 to-yellow-500 rounded-t">
              <CardTitle className="text-[14px] text-slate-800 font-bold truncate text-center whitespace-nowrap overflow-hidden max-w-full">{conteggioPerSedeOrdinato?.[2]?.sede || "-"}</CardTitle>
            </CardHeader>
            <CardContent className="p-4 pt-1 flex flex-col justify-center items-center h-full">
        ...
        <div>
          <Card className="border border-yellow-600 rounded-md flex flex-col justify-between h-full w-full">
            <CardHeader className="p-2 bg-gradient-to-br from-yellow-600 to-yellow-500 rounded-t">
              <CardTitle className="text-[14px] text-slate-800 font-bold truncate text-center whitespace-nowrap overflow-hidden max-w-full">{conteggioPerSedeOrdinato?.[3]?.sede || "-"}</CardTitle>
            </CardHeader>
            <CardContent className="p-4 pt-1 flex flex-col justify-center items-center h-full">
        ...
        <div>
          <Card className="border border-yellow-600 rounded-md flex flex-col justify-between h-full w-full">
            <CardHeader className="p-2 bg-gradient-to-br from-yellow-600 to-yellow-500 rounded-t">
              <CardTitle className="text-[14px] text-slate-800 font-bold truncate text-center whitespace-nowrap overflow-hidden max-w-full">{conteggioPerSedeOrdinato?.[4]?.sede || "-"}</CardTitle>
            </CardHeader>
            <CardContent className="p-4 pt-1 flex flex-col justify-center items-center h-full">
